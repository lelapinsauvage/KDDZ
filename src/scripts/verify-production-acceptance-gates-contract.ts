...
assert.match(contents.gates, /preflight `blockingGateSummary`, closeout-plan artifact hash, redacted closeout-plan work-order summary, and hash-bound readiness env template artifacts/);

...
assert.match(contents.gates, /requiring the blocker-status report plus nested focused manifest to match the source matrix\/gate-map\/production-gates paths recorded in the saved manifest/);

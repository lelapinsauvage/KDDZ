...
function addSummary(
  total: HolidayGenerationSummary,
  next: HolidayGenerationSummary,
) {
...
async function runHolidayCron(request: NextRequest) {
  ...
  for (const target of resolved.targets) {
    const summary = await generateHolidayAlarmsForOrganization(target);
